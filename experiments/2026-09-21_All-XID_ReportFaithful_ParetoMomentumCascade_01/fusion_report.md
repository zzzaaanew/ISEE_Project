...
- Fusion PR-AUC: `0.022981`
- Branch 1 Cascade PR-AUC: `0.020299`
- Branch 2 History-only PR-AUC: `0.061371`
- Fusion ROC-AUC: `0.699862`
- Recall@100: `7.83%`
- Lift@100: `1.559x`
- Mean Pareto B1 weight: `0.4524`

## Pareto sensitivity grid
- `wc0.30_wr0.05_a1.0`: PR-AUC `0.025391`, ROC-AUC `0.704038`, mean B1 weight `0.2752`
- `wc0.30_wr0.02_a1.0`: PR-AUC `0.025302`, ROC-AUC `0.703812`, mean B1 weight `0.2723`
- `wc0.30_wr0.05_a1.5`: PR-AUC `0.025156`, ROC-AUC `0.703989`, mean B1 weight `0.2695`
- `wc0.30_wr0.02_a1.5`: PR-AUC `0.025012`, ROC-AUC `0.703843`, mean B1 weight `0.2659`
- `wc0.50_wr0.05_a1.0`: PR-AUC `0.023011`, ROC-AUC `0.699856`, mean B1 weight `0.4554`
- `wc0.50_wr0.02_a1.0`: PR-AUC `0.022981`, ROC-AUC `0.699862`, mean B1 weight `0.4524`
- `wc0.50_wr0.05_a1.5`: PR-AUC `0.022834`, ROC-AUC `0.699973`, mean B1 weight `0.4451`
- `wc0.50_wr0.02_a1.5`: PR-AUC `0.022769`, ROC-AUC `0.699895`, mean B1 weight `0.4415`
