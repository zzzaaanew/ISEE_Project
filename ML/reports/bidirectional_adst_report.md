...
## 2. 종합 평균 평가 지표
- **Fused PR-AUC**: `0.0415` (Branch 1 단독: `0.0217`, Branch 2 단독: `0.0463`)
- **Fused ROC-AUC**: `0.6792`
- **Top-100 Fault Recall (상위 5% 자원)**: `20.4%`
- **Top-100 Fault Lift**: `4.06배` (무작위 대비)

## 3. 양방향 동적 윈도우 선택 통계
- **학습 기간($L_{train}$) 선택 분포**: {21: 23, 7: 21, 14: 19}
- **관측 시간($L_{obs}$) 선택 분포**: {24: 23, 6: 20, 1: 20}
